    ...
    >
      <div className="flex justify-between items-center h-full w-[1019.48px] mx-auto gap-[73px]
        ...
        <motion.div
          ...
          className="w-[519.07px] h-[525.87px] order-1 max-[1000px]:w-full max-[1000px]:h-auto max-[1000px]:order-0"
        >
        ...
        <motion.div
          ...
          className="w-[427.41px] h-[294.68px] flex flex-col justify-between items-start gap-[21px]
        ...
        >
          <motion.div
            ...
            className="flex flex-col gap-[8px] w-full max-[1000px]:items-center"
          >
          ...
          <motion.p
            ...
            className="text-[#FFFFFF] text-[16px] font-[400] leading-[148%] tracking-[0%] w-full h-[70.84px]
          ...
          <motion.div
            ...
            className="w-full h-[61px] max-[1000px]:h-auto max-[1000px]:mt-4 flex flex-col items-start max-[1000px]:items-center"
          >
